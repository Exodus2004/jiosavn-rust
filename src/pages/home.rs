...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <meta name="description" content="JioSaavn API is an unofficial wrapper written in Rust for jiosaavn.com providing programmatic access to a vast library of songs, albums, artists, playlists, and more." />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="JioSaavn API (Rust)" />
    <meta property="og:description" content="JioSaavn API is an unofficial wrapper written in Rust for jiosaavn.com providing programmatic access to a vast library of songs, albums, artists, playlists, and more." />
    <meta property="twitter:card" content="summary_large_image" />
    <meta property="twitter:title" content="JioSaavn API (Rust)" />
    <meta property="twitter:description" content="JioSaavn API is an unofficial wrapper written in Rust for jiosaavn.com providing programmatic access to a vast library of songs, albums, artists, playlists, and more." />
  ...
  <body class="bg-black mx-auto md:min-h-screen max-w-screen-lg flex flex-col">
    <main class="mx-auto my-auto flex flex-col space-y-8 px-4 pb-8 md:py-10 relative overflow-y-hidden overflow-x-hidden w-full">
      ...
      <div class="absolute inset-0 pointer-events-none overflow-hidden">
        <span class="meteor animate-[meteorAnimation_3s_linear_infinite] absolute h-1 w-1 rounded-[9999px] shadow-[0_0_0_1px_#ffffff10] rotate-[215deg]" style="top: 0px; left: 100px; animation-delay: 0.2s; animation-duration: 4s;"></span>
        <span class="meteor animate-[meteorAnimation_3s_linear_infinite] absolute h-1 w-1 rounded-[9999px] shadow-[0_0_0_1px_#ffffff10] rotate-[215deg]" style="top: 0px; left: 250px; animation-delay: 0.5s; animation-duration: 6s;"></span>
        <span class="meteor animate-[meteorAnimation_3s_linear_infinite] absolute h-1 w-1 rounded-[9999px] shadow-[0_0_0_1px_#ffffff10] rotate-[215deg]" style="top: 0px; left: -150px; animation-delay: 0.8s; animation-duration: 3s;"></span>
        <span class="meteor animate-[meteorAnimation_3s_linear_infinite] absolute h-1 w-1 rounded-[9999px] shadow-[0_0_0_1px_#ffffff10] rotate-[215deg]" style="top: 0px; left: 380px; animation-delay: 0.3s; animation-duration: 5s;"></span>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-4 lg:grid-cols-4 xl:grid-cols-8 gap-2 sm:gap-0 relative grid-flow-row">
        <a class="p-4 sm:p-8 hover:bg-opacity-5 hover:bg-white rounded-lg duration-100 sm:col-span-4" href="/swagger-ui">
          <div class="flex flex-col">
            ...
            <span class="text-neutral-200 font-bold text-lg sm:text-xl md:text-2xl mt-2">Explore the Swagger Docs</span>
            <div class="text-neutral-500 mt-2">
              Check out the documentation to learn how to use the JioSaavn API in Rust.
            </div>
          </div>
        </a>

        <a target="_blank" class="p-4 sm:p-8 hover:bg-opacity-5 hover:bg-white rounded-lg duration-100 sm:col-span-4" href="https://github.com/sumitkolhe/jiosaavn-api">
          <div class="flex flex-col">
        ...
        <a target="_blank" class="p-4 sm:p-8 hover:bg-opacity-5 hover:bg-white rounded-lg duration-100 sm:col-span-4" href="https://github.com/sumitkolhe/jiosaavn-api/issues">
          <div class="flex flex-col">
        ...
        <div class="p-4 sm:p-8 hover:bg-opacity-5 hover:bg-white rounded-lg duration-100 sm:col-span-4">
          <div class="flex flex-col">
            ...
            <div class="text-neutral-500 mt-2">
              ...
              <a href="https://twitter.com/thesumitkolhe" target="_blank" rel="noopener noreferrer" class="hover:underline text-sky-500">Twitter</a>, or 
